...
test('pad should add (n) whitespaces if pad is a number', t => {
...
test('pad should pad the string with given characters', t => {
...
test('pad should pad given number with given characters', t => {
